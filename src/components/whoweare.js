        ...
        <div className="wwacontainer">
            <div className="WWAMain" id="WhoWeAre">
                ...
                <p className="WWAI" >we<b>merch</b> is a merchandising management agency,<br/> built 
                    ...
                    influencers take their careers to the <b>next<br/> level</b> by designing and producing their merch. 
                    <br/> <br/>All while maintaining a hassle-free, <br/>friendly environment.</p>
            </div>
        </div>
    )
}